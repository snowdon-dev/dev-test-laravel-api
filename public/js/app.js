...
var axiosModule = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
...
var messageDOM = document.getElementById('messageBody');
var messageContainer = document.getElementById('messageContainer');

var submitMessageEvent = /*#__PURE__*/function () {
  ...
  return function submitMessageEvent() {
    return _ref.apply(this, arguments);
  };
}();

var logoutEvent = /*#__PURE__*/function () {
...
var renderMessageEvent = function renderMessageEvent(messages) {
  var template = function template(message) {
    return "author: ".concat(message.user.name, ", message: ").concat(message.message, ", createdAt: ").concat(message.created_at);
  };
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return axios.get('/api/messages', getConfig());
...
var loginEvent = /*#__PURE__*/function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            _context5.next = 5;
            return axios.post("api/sanctum/token", payload);

          case 5:
            response = _context5.sent;
            tokenTmp = response.data.token; // set token
